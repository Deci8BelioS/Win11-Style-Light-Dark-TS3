...
<table width="100%" class="Infoframe_table">
	<tr title="Channel ID: %%CHANNEL_ID%%">
		<td>
		<span><img src="iconpath:MODERATED?size=22x22" height="30" width="30" alt="" title="Solicita poder de conversación para poder hablar en este canal." /> </span><span class="Infoframe_hidden">%%?CHANNEL_NEEDED_TALK_POWER%%</span>
	...
	<tr>
		<td>
			<table width="100%" class="Infoframe_nospace">
				...
				<tr>
					<td class="Infoframe_label">Calidad del códec:</td>
		...
		<td>
			<table width="100%" class="Infoframe_nospace">
				...
				<tr><td class="Infoframe_label">Cifrado de voz:</td> <td class="Infoframe_list"> %%CHANNEL_VOICE_DATA_ENCRYPTED%% <img src="styles:/Win11 Style Dark/imagesinfo/encrypted_12x12.png" alt="%%CHANNEL_VOICE_DATA_ENCRYPTED_FLAG%%" /></td></tr>
				<tr><td class="Infoframe_label" valign="center">Poder para hablar:</td><td class="Infoframe_orange Infoframe_list"><img src="iconpath:MODERATED?size=12x12" alt="" title="Solicite permiso para hablar en este canal." />&nbsp;&nbsp;%%?CHANNEL_NEEDED_TALK_POWER%%</td></tr>
			</table>
		</td>
	</tr>
</table>
...
<table class="Infoframe_table" width=100%>
	<tr><td colspan="2" class="Infoframe_text-center"><p style="margin-top: 4px; font-weight: bold; font-size: 15px;" class="Infoframe_red">El canal se borrará en %%?TEMP_CHANNEL_TIME_TO_DELETE%%.</p></td></tr>
