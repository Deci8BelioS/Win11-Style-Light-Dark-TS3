	...
	<tr>
		<td>
			<table width="330" class="Infoframe_nospace">
				...
				<tr><td class="Infoframe_label">Version: </td><td class="Infoframe_list"><span title="%%CLIENT_VERSION_STATE%%">%%CLIENT_VERSION%%</span> in: <span title="%%CLIENT_PLATFORM%%"><img src="styles:/Win11 Style Dark/imagesinfo/%%CLIENT_PLATFORM%%.png" alt="" title="%%CLIENT_PLATFORM%%" /></span></td></tr>
				...
				<tr><td class="Infoframe_label">Last connection: </td><td class="Infoframe_list">%%CLIENT_LASTCONNECTED%%</td> </tr>
